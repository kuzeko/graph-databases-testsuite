 ...
 * Q 45 -
 */
public class NodePathLabelSearch extends AllPaths {
    ...
    protected Collection<TimingCheckpoint> query(GraphTraversalSource gts, AllPaths.QParam params, Sample sample, Dataset ds, final long thread_id, GenericIndexMgm imgm, GenericShell shell) {
        ...
        ts.add(new TimingCheckpoint(end - start, String.format("Found %d paths from %s : %s", numPaths, p.source_id, pathString), params));
