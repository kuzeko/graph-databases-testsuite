...
// NOTE: we shall be able to polling with `CALL db.indexes` instead,
// but for some reason API just explode.
wp = 1000*60*60*1;
System.err.println("Allowing " + wp + " seconds for the indexes to build.");
Thread.sleep(wp);
