...
// ex: -friend
result_row = [ DATABASE, DATASET, QUERY+"-friend1", String.valueOf(SID), ITERATION, String.valueOf(ORDER_j), String.valueOf(exec_time), "friend1 " + friend1.size()];
println result_row.join(',');
...
// ex: -friend 
result_row = [ DATABASE, DATASET, QUERY+"-friend1", String.valueOf(SID), ITERATION, String.valueOf(ORDER_j), String.valueOf(exec_time), "friend2 " +   friend2.size()];
println result_row.join(',');
...
// ex: friend-and
result_row = [ DATABASE, DATASET, QUERY+"-friend2", String.valueOf(SID), ITERATION, String.valueOf(ORDER_j), String.valueOf(exec_time), "friend3 " + friend3.size()];
println result_row.join(',');
...
// ex: q1
result_row = [ DATABASE, DATASET, QUERY+"-friend-of-friend", String.valueOf(SID), ITERATION, String.valueOf(ORDER_j), String.valueOf(exec_time),  list.size()];
println result_row.join(',');
